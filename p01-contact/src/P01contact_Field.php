...
class P01contactField
{
    ...
    public function html()
    {
        ...
        if ($is_single_option) {
            $html  = "<div class=\"uk-margin $type $orig $required\">";
        } else {
            $html  = "<div class=\"uk-margin $type $orig $required\">";
        ...
        switch ($type) {
            case 'textarea':
                $html .= '<textarea class="uk-textarea uk-border-rounded" id="' . $id . '" rows="6" ';
            ...
            case 'radio':
                ...
                foreach ($this->value as $i => $v) {
                    ...
                    $html .= " type=\"$type\" class=\"uk-$type\" name=\"{$name}\"";
                ...
                break;
            case 'select':
                $html .= '<select class="uk-select uk-border-rounded" id="' . $id . '" name="' . $name . '" ' . $required . '>';
                foreach ($this->value as $i => $v) {
                ...
                break;
            default:
                $html .= '<input class="uk-input uk-border-rounded" id="' . $id . '" ';
    ...
    private function htmlLabel($for)
    {
        ...
        if ($this->error) {
            $html .= '<div class="uk-alert-danger uk-width-1-1 uk-margin-small" uk-alert><a class="uk-alert-close" uk-close></a>' . $this->form->lang($this->error) . '</div>';
        }
        $html .= '</label>';
        return $html;
    }
